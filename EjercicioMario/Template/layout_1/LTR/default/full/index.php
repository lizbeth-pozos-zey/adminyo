						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#"></a> <span class="font-weight-semibold">Design</span> branch
								...
								<li class="media">
									...
									<div class="media-body">
										<a href="#"></a> <span class="font-weight-semibold">r</span> <span class="font-weight-semibold"></span> branches
										<div class="text-muted font-size-sm"></div>
									</div>
								</li>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="media-title font-weight-semibold">VICTORIA TAMAULIPAS</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Forms -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">FORMULARIO</div> <i class="icon-insert-template" title="FORMULARIO"></i></li>
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
						 ...
						 Forms -->
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-clipboard3"></i> <span>ALUMNO</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="form_layout_vertical.html" class="nav-link">ALUMNOS</a></li>
								<!--
								...
								<li class="nav-item-divider"></li>
							-->
								<li class="nav-item"><a href="form_layout_horizontal.html" class="nav-link">DOCENTE</a></li>
								<!--
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-clipboard3"></i> <span> DOCENTE </span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								<li class="nav-item"><a href="form_layout_vertical.html" class="nav-link">
...
<!--
						...
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">MODULO</div> <i class="icon-insert-template" title="Components"></i></li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-insert-template"></i> <span>MODULO</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								<li class="nav-item"><a href="components_modals.html" class="nav-link">DOCENTE</a></li>
							<!--
						...
						<!-- Tables -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">LISTAS </div> <i class="icon-menu" title="VISTA DE DATOS "></i></li>
						<!--
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-table2"></i> <span> LISTAS ALUMNOS</span></a>

							>
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="table_basic.html"


								 class="nav-link">Basic examples</a></li>
					...
					-->
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil7"></i> <span> LISTAS DOCENTES</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_basic.html" class="nav-link">LISTAS DE DATOS ALUMNOS/DOCENTES</a></li>

                             <li class="nav-item"><a href="datatable_styling.html" class="nav-link">MATERIAS</a></li>
